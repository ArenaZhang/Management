  ...
  $(".leftnav ul li a").click(function(){
	...
	<ul class="bread">
		<li><a target="right" class="icon-home">
				首页</a></li>
		<li><a href="##" id="a_leader_txt">单个查询设备列表</a></li>
	</ul>
			...
			<table class="table table-hover text-center">
				...
				<td><div class="button-group">
								<a class="button border-blue"
									href="${pageContext.request.contextPath }/itemsController/updateItemsState.action?id=${itemx.eid}">
				...
				<td><div class="button-group">
								 <a class="button border-blue"
									href="${pageContext.request.contextPath }/itemsController/itemsGood.action?id=${itemx.eid}">
				...
				<td><div class="button-group">
								<a class="button border-blue"
									href="${pageContext.request.contextPath }/itemsController/itemsBack.action?id=${itemx.eid}">
				...
				<td><div class="button-group">
								 <a class="button border-blue"
									href="${pageContext.request.contextPath }/itemsController/itemsUse.action?id=${itemx.eid}">
									<span class="icon-trash-o"></span> 更改状态
								 </a>
							     </div>
				</td>
