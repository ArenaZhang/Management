...
function update(){
	 document.userForm.action="${pageContext.request.contextPath }/itemsController/updateItemsBack.action";
...
$(function(){
  ...
  $(".leftnav ul li a").click(function(){
	...
	<div class="admin">
		<form class="form-x" name="userForm" >
        ...
        <div  class="label">
         <input class="input"  name="eid"  value=" ${item.eid}" type="hidden"/> 
        </div>
        </div>
        ...
        <div  class="label">
          <input  class="input" name="ename" value="${item.ename}" type="hidden"/>
        </div>
        </div>
       ...
       <div class="form-group">
        ...
        <select name="estatus" class="input"	style="width:240px; line-height:17px; display:inline-block">
